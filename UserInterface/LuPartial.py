import lu_partial_window
from PyQt5 import QtCore, QtGui, QtWidgets
import numpy as np
from CustomDialog import CustomDialog
from MatrixAnswer import MatrixAnswer
from Methods.LuPartial import LuPartialMethod


class LuPartial(QtWidgets.QWidget, lu_partial_window.Ui_lu_partial_window):
    def __init__(self, parent=None):
        super(LuPartial, self).__init__(parent)
        self.setupUi(self)
