...
# Form implementation generated from reading ui file 'Designer/lu_partial_window.ui'
#
...
class Ui_lu_partial_window(object):
    def setupUi(self, lu_partial_window):
        lu_partial_window.setObjectName("lu_partial_window")
        lu_partial_window.resize(900, 700)
        lu_partial_window.setMinimumSize(QtCore.QSize(900, 700))
        lu_partial_window.setMaximumSize(QtCore.QSize(900, 700))
        ...
        self.matrix_button = QtWidgets.QPushButton(lu_partial_window)
...
"")
        ...
        self.run_button = QtWidgets.QPushButton(lu_partial_window)
...
"")
        ...
        self.retranslateUi(lu_partial_window)
        QtCore.QMetaObject.connectSlotsByName(lu_partial_window)
...
if __name__ == "__main__":
    ...
    lu_partial_window = QtWidgets.QWidget()
    ui = Ui_lu_partial_window()
    ui.setupUi(lu_partial_window)
    lu_partial_window.show()
    sys.exit(app.exec_())
