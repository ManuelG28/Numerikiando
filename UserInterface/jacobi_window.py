...
# Form implementation generated from reading ui file 'Designer/jacobi_window.ui'
#
...
class Ui_jacobi(object):
    def setupUi(self, jacobi):
        jacobi.setObjectName("jacobi")
        jacobi.resize(900, 700)
        jacobi.setMinimumSize(QtCore.QSize(900, 700))
        jacobi.setMaximumSize(QtCore.QSize(900, 700))
...
"")
        ...
        self.run_button = QtWidgets.QPushButton(jacobi)
...
"")
        ...
        self.t_input = QtWidgets.QTextEdit(jacobi)
        ...
        QtCore.QMetaObject.connectSlotsByName(jacobi)
