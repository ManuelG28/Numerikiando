...
from Methods.Crout import CroutMethod


class Crout(QtWidgets.QWidget, crout_window.Ui_crout):
    def __init__(self, parent=None):
        super(Crout, self).__init__(parent)
        self.setupUi(self)
    ...
    def runMethod(self):
        ...
        if self.a_matrix is not None and self.b_vector is not None:
            crout = CroutMethod(self.a_matrix, self.b_vector)
            crout.Crout()
            answer = crout.answer
