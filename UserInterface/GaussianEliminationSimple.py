import gauss_elim_simple_window
from PyQt5 import QtCore, QtGui, QtWidgets
import numpy as np
from Methods.GaussianEliminationSimple import GaussianEliminationSimpleMethod
from CustomDialog import CustomDialog
from MatrixAnswer import MatrixAnswer



class GaussianEliminationSimple(QtWidgets.QWidget, gauss_elim_simple_window.Ui_gauss_elim_simple):
    def __init__(self, parent=None):
        super(GaussianEliminationSimple, self).__init__(parent)
        self.setupUi(self)
    ...
    def runMethod(self):
        ...
        if (self.a_matrix is not None) and (self.b_vector is not None):
            ...
            gauss_simple = GaussianEliminationSimpleMethod(self.n, ab)
            gauss_simple.Gaussian()
            answer = gauss_simple.answer
