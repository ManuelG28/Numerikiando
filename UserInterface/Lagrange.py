import lagrange_window
from PyQt5 import QtCore, QtGui, QtWidgets
import numpy as np
from Methods.Lagrange import LagrangeMethod
from CustomDialog import CustomDialog
from MatrixAnswer import MatrixAnswer



class Lagrange(QtWidgets.QWidget, lagrange_window.Ui_lagrange):
    def __init__(self, parent=None):
        super(Lagrange, self).__init__(parent)
        self.setupUi(self)
    ...
    def runMethod(self):
        ...
        if (self.x1_vector is not None):
            la = LagrangeMethod(self.x1_vector, self.y1_vector)
            la.lagrange()
            answer = la.answer
