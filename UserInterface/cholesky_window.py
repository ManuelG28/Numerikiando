...
# Form implementation generated from reading ui file 'Designer/cholesky_window.ui'
#
...
class Ui_cholesky(object):
    def setupUi(self, cholesky):
        cholesky.setObjectName("cholesky")
        cholesky.resize(900, 700)
        cholesky.setMinimumSize(QtCore.QSize(900, 700))
        cholesky.setMaximumSize(QtCore.QSize(900, 700))
...
"")
        ...
        self.run_button = QtWidgets.QPushButton(cholesky)
...
"")
        ...
        self.retranslateUi(cholesky)
        QtCore.QMetaObject.connectSlotsByName(cholesky)

    def retranslateUi(self, cholesky):
        _translate = QtCore.QCoreApplication.translate
        cholesky.setWindowTitle(_translate("cholesky", "Form"))
        self.matrix_button.setText(_translate("cholesky", "Generate Matrix"))
        self.run_button.setText(_translate("cholesky", "Run method"))
import link_rc
