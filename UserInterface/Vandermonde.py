import vandermonde_window
from PyQt5 import QtCore, QtGui, QtWidgets
import numpy as np
from Methods.Vandermonde import VandermondeMethod
from CustomDialog import CustomDialog
from MatrixAnswer import MatrixAnswer



class Vandermonde(QtWidgets.QWidget, vandermonde_window.Ui_vandermonde):
    def __init__(self, parent=None):
        super(Vandermonde, self).__init__(parent)
        self.setupUi(self)
    ...
    def runMethod(self):
        ...
        if (self.x1_vector is not None):
            la = VandermondeMethod(self.x1_vector, self.y1_vector)
            la.vandermonde()
            answer = la.answer
